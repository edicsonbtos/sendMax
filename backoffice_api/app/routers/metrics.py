...
def operators_ranking(days: int = Query(default=7, le=90), api_key: str = Depends(verify_api_key)):
...
def metrics_corridors(days: int = Query(default=30, le=90), api_key: str = Depends(verify_api_key)):
