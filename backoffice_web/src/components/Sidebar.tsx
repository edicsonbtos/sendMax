            ...
            <ListItem key={item.path} disablePadding sx={{ mb: 0.5 }}>
              <ListItemButton
                ...
                sx={{
                  ...
                  py: 1.25,
                  px: 1.5,
                  backgroundColor: isActive ? '#EFEAFF' : 'transparent',
                  border: isActive ? '1px solid #D8CCFF' : '1px solid transparent',
                  '&:hover': {
                    backgroundColor: isActive ? '#EFEAFF' : '#FAF8FF',
                    border: isActive ? '1px solid #D8CCFF' : '1px solid #E9E3F7',
                  },
