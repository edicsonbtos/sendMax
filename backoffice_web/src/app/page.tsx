                ...
                {profitDaily.length>0?(
                  <ResponsiveContainer width="100%" height={260}>
                    <AreaChart data={profitDaily}>
                      ...
                      <RechartsTooltip contentStyle={{borderRadius:12,border:'1px solid #E9E3F7',boxShadow:'0 8px 24px rgba(17,24,39,.06)',fontSize:13}} formatter={(value: any, name: any)=>{const n=typeof value==='number'?value:Number(value??0);const label=name==='profit'?'Profit teorico':name==='profit_real'?'Profit real':(name||'');return['\$'+n.toFixed(2),label];}}/>
