...
# ============================================================================
# CÓDIGO EXTRAÍDO - MÓDULO CIERRE DIARIO
# ============================================================================
...
async def execute_daily_closure(
    ...
    if existing and not payload.force:
        raise HTTPException(status_code=409, detail=f"Cierre para el dÃ­a {d} ya existe. Use 'force' para sobrescribir.")
...
async def export_closure_csv(
    ...
    writer.writerow(["Ã“rdenes Totales", row['total_orders_count']])
