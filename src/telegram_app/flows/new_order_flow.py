...
# Paises validos como ORIGEN (nunca Ð¿ÑÐµÐ²Ð´Ð¾-destinos)
...
# â”€â”€ Address Book handlers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
async def receive_save_alias(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if not order_data:
        await update.message.reply_text("âŒ No se encontraron datos de la orden para guardar.")
...
async def receive_proof(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    if update.message and update.message.text:
        ...
        await _screen_send_or_edit(
            update,
            context,
            "âš ï¸ Por favor, adjunta la foto o captura del comprobante de pago para poder finalizar tu orden.",
            reply_markup=_cancel_keyboard(),
        )
        return ASK_PROOF
...
async def _try_auto_approve(
    *,
    ...
    try:
        ...
        def _cfg_str(v) -> str:
            """Normalize value_json (JSONB: may be dict, str, bool, int, float) â†’ str."""
        ...
        if cfg.get("auto_approve_enabled", "false").lower() != "true":
            return False  # Feature flag OFF â†’ flujo normal
        ...
        logger.info(
            "[AutoPilot] Orden #%s auto-aprobada â€” operador=%s score=%.1f usd_est=%.2f",
...
async def receive_confirm(update: Update, context: ContextTypes.DEFAULT_TYPE) -> int:
    ...
    # â”€â”€ Snapshot de beneficiario guardado â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
