...
@app.get("/orders/{public_id}/trades")
...
@app.post("/orders/{public_id}/trades")
def create_order_trade(public_id: int, payload: OrderTradeIn, api_key: str = Depends(verify_api_key)):
    ...
    # Recalcular profit real y guardarlo en orders.profit_real_usdt
    agg = fetch_one(
        """
        SELECT
    ...
    # En tu flujo: profit real = BUY - SELL - fees
